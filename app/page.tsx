      ...
      <section className="bg-white dark:bg-slate-950 py-16 md:py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
            All processing happens locally in your browser using the Web Canvas API. We never upload, store, or transmit your files to any server. Zero data collection. GDPR compliant.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {['No uploads', 'No servers', 'No tracking', 'GDPR compliant', '100% free'].map((badge) => (
